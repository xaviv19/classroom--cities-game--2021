...
@Component
public class WoodMillFactory implements BuilderFactory {
    ...
    public WoodMillFactory(EntityIdGenerator entityIdGenerator, ContainedsController containedsController, NamedsController namedsController, TypedsController typedsController, ResourcedsController resourcedsController, ResourcedModifiersController resourcedModifiersController) {
    ...
    public String build(String containerId) {
        ...
        resourcedModifiersController.create(entityId, ResourceType.WOOD, 1, 0);
        return entityId;
    }
}
