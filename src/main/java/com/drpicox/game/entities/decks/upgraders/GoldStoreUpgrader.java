...
@Component
public class GoldStoreUpgrader implements LeveledUpgrader {
    ...
    public GoldStoreUpgrader(ContainedsController containedsController, ResourcedsController resourcedsController, ResourcedModifiersController resourcedModifiersController, DocksController docksController) {
