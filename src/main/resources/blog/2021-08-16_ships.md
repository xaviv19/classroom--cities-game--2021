 ...
 * You should be at the ship screen.
 * The ship should be "Beagle".
 * The ship should be of "leonard".
 * The ship population should be 0.

### Changing the name

You can change the name of your ships.

 * Enter new ship name "Cerritos".
 * Click the change ship name button.
 <!-- SNAPSHOT status=200 -->

And now you can see the new name.

 * You should be at the ship screen.
 * The ship should be "Cerritos".
 ...
 * Click on the "leonard" city "Capital"
 * The city population should be 6.
 * Click on the "leonard" ship "Beagle".
 * The ship population should be 5.
 * The load/unload amount should be 0.
 * The load button should be normal.
 * The unload button should be normal.
 ...
 * Click on the "leonard" ship "Beagle".
 * The ship population should be 1.
 * The load/unload amount should be 0.
 * The load button should be normal.
 * The unload button should be normal.
 ...
 * You should be at the game screen.
 * Click on the "leonard" city "Capital"
 * The city population should be 1.
 * Click on the "leonard" ship "Beagle".
 * The ship population should be 12.
 ...
 * You should be at the game screen.
 * Click on the "leonard" city "Capital"
 * The city population should be 9.
 * Click on the "leonard" ship "Beagle".
 * The ship population should be 12.
 ...
 * You should be at the game screen.
 * Click on the "leonard" city "Capital"
 * The city population should be 2.
 * Click on the "leonard" ship "Beagle".
 * The ship population should be 20.
