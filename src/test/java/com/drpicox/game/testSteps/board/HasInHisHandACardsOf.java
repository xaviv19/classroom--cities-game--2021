...
@Component
public class HasInHisHandACardsOf extends AbstractPostLineStep {

    private final TestPostForms testPostForms;

    public HasInHisHandACardsOf(TestPostForms testPostForms) {
    ...
    protected String getRegex() {
        ...
        return "_([^_]+)_ has in h[ei][rs] hand an? _([^_]+)_ card of _([^_]+)_";
    }
