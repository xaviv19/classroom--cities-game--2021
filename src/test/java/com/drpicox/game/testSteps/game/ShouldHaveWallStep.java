...
@Component
public class ShouldHaveWallStep extends AbstractPostLineStep {
    ...
    public ShouldHaveWallStep(GameTestView gameTestView, PlayersController playersController, GamesController gamesController, OwnedsController ownedsController, TypedsController typedsController, QuantityController quantityController) {
    ...
    protected String getRegex() {
        return "\"([^\"]+)\" should have a quantity of (\\d+) wall.";
    }
    ...
    protected void run(PostLine line, String[] match) {
        ...
        var types = getIds(typedsController.findAllByGameAndType(game, "WALL"));
