...
@Component
public class PlaysACardOfIntoThePile extends AbstractPostLineStep {

    private final TestPostForms testPostForms;

    public PlaysACardOfIntoThePile(TestPostForms testPostForms) {
        this.testPostForms = testPostForms;
    }

    @Override
    protected String getRegex() {
        return "_([^_]+)_ plays an? _([^_]+)_ card of _([^_]+)_ into the _([^_]+)_ pile";
    }
